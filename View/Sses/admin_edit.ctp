...
<?php echo $this->Form->create('Ss');?>
	<fieldset>
		<legend><?php echo __('Admin Edit Ss'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Ss.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Ss.id'))); ?></li>
