<div class="skills index">
	...
	foreach ($skills as $skill): ?>
        <?$img_url = $this->StrChanger->Dehumanize($skill['Skill']['name_en'])?>
	<tr>
		...
		<td>
			<?php echo $this->Html->link($skill['Champion']['name'], array('controller' => 'champions', 'action' => 'view', $skill['Champion']['id'])); ?>
                ...
                <td><img src="<?=$this->base?>/img/lol/champions/<?=$this->StrChanger->Dehumanize($skill['Champion']['name'])?>/<?=$img_url?>.png" alt="<?=$skill['Skill']['name_en']?>"/></td>
